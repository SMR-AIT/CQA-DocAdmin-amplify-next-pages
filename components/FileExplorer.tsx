...
function App({ signOut, user }: WithAuthenticatorProps) {
    ...
    return (
        <main className="app-container">
            ...
            <ScrollView height="300px" width="800px" maxWidth="100%" marginBottom={20} marginTop={20}>
                <Table size="small" variation="striped" highlightOnHover={true}>
                    <TableHead>
                        <TableRow>
                            ...
                            <TableRow key={doc.id}>
                                <TableCell>
                                    <a href={doc.url!}
                                        ...
                                        }}>{getIcon(doc.type?.toString()!)} {doc.name}{" "}</a>
                                </TableCell>
                                <TableCell>
                                    <Button size="small"
                                        variation="primary"
